  ...
  return (
    <section className="bg-surface pb-24 pt-36">
      <div className="container-padded">
        <SectionHeader eyebrow="Contact Us" title="Reach the School Office" description="The verified institutional contact details are preserved verbatim from the legacy archive." />
